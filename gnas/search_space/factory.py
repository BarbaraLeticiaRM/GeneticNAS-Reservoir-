...
if(args.reservoir_operation == 'Reservoir'):
    CNN_OP = ['Dw3x3', 'Identity', 'Dw5x5', 'Avg3x3', 'Max3x3', 'Reservoir']
elif(args.reservoir_operation == 'Reservoir-LSTM'):
    CNN_OP = ['Dw3x3', 'Identity', 'Dw5x5', 'Avg3x3', 'Max3x3', 'Reservoir_lstm']
elif(args.reservoir_operation == 'Reservoir-CNN'):
    CNN_OP = ['Dw3x3', 'Identity', 'Dw5x5', 'Avg3x3', 'Max3x3', 'Reservoir_cnn']
elif(args.reservoir_operation == 'None'):
    CNN_OP = ['Dw3x3', 'Identity', 'Dw5x5', 'Avg3x3', 'Max3x3']
else:
    raise Exception('unkown reservoir_operation:' + args.reservoir_operation)
